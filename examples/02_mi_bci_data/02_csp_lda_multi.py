"""
Example 02: CSP + LDA on 3-class motor imagery data
===================================================
"""
...
data = dataset.get_data(subjects=[subject])[subject][session]
...
for name, raw in data.items():
    ...
    epochs = epochs[["left_hand", "right_hand", "feet"]]
...
lda = LinearDiscriminantAnalysis(shrinkage="lwf")
